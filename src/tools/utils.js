...
//获取时间戳
export function tiems(){
  return new Date().getTime();
}

//微信浏览器 回退事件
export function backFn(fn) {
...
export function getAddr(addrtxt) {
  return new Promise((resolve, reject) => {
      $.get({
          url: "http://api.map.baidu.com/geocoder/v2/?address=" + addrtxt + "&output=json&ak=VGdcEKvDI74Iw2y2LGhx4baYnWSb1Ygf&callback=showLocation",
          dataType: 'jsonp',
